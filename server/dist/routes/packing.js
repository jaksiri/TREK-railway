...
router.post('/import', auth_1.authenticate, (req, res) => {
    const authReq = req;
    const { tripId } = req.params;
    ...
    const stmt = database_1.db.prepare('INSERT INTO packing_items (trip_id, name, checked, category, weight_grams, bag_id, sort_order) VALUES (?, ?, ?, ?, ?, ?, ?)');
    const created = [];
